...
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس المملكه ميوزك\n
𝐿𝐾 ダ ᴍᴜsɪᴄ source ↜

**𖢿قايمه مميزات سورس المملكه الليبي
...
مطـور الســـورس الڪرغلي الليبي
𝐿𝐾 ダ ᴍᴜsɪᴄ source ↜
لتنصيب بوت مشابه تواصل معي فالخاص @L_ii_Q
**""",
